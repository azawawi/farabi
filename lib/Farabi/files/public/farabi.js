	...
	var showEditorStats = function(cm) {
		...
		$editorStats.html(
			...
			'&nbsp;<span class="badge badge-info"><strong>Characters: ' + cm.getValue().length + '</strong></span>&nbsp;' +
				((problemCount > 0) ? '<span id="problems-button" class="badge badge-important"><strong>Problems: ' + problemCount + '</strong></span>' : '<span class="badge badge-success"><strong>Syntax Check OK</span>')
		);
