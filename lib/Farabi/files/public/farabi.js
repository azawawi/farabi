	...
	var showEditorStats = function(cm) {
		...
		$editorStats.html(
			...
			'&nbsp;<span class="badge badge-info"><strong>Characters: ' + cm.getValue().length + '</strong></span>&nbsp;' +
				((problemCount > 0) ? '<button id="problems-button" class="btn btn-danger"><strong>Problems: ' + problemCount + '</strong></button>' : '<span class="badge badge-success"><strong>Syntax Check OK</span>')
		);
