...
$(function() {
	...
	var showEditorStats = function(cm) {
		...
		$('.editor_stats').html(
			'<span class="label label-info"><strong>' + line_number + '</strong>' + plural(line_number) + ' line</span>' +
			', <span class="label label-info"><strong>' + column_number + '</strong>' + plural(column_number) + ' column</span>' +
			', <span class="label label-info"><strong>' + cm.lineCount() + '</strong>&nbsp;lines</span>' +
			(selection ?  ', <strong>' + selection.length +'</strong></span>&nbsp;selected characters' : '')  +
			', <span class="label label-info"><strong>' + cm.getValue().length + '</strong>&nbsp;characters</span>' +
			', <span class="label label-info"><strong>' + cm.lineCount() + '</strong>&nbsp;lines</span>&nbsp;&nbsp;' +
			((problemCount > 0) ? ', <span class="label label-important"><strong>' + problemCount + '&nbsp;</strong>Problem(s)</span>' : '<span class="label label-success"><strong>Syntax Check OK</span>')
